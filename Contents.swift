...
for album in allAlbumss {
    let studioAlbum = album as? StudioAlbumm
}
...
for album in allAlbumss {
    ...
    if let studioAlbum = album as? StudioAlbumm {
        print(studioAlbum.studio)
    } else if let liveAlbum = album as? LiveAlbumm {
...
var taylorSwifttt = StudioAlbum(name: "Taylor Swift", studio: "The Castles Studios")
var fearlessss = StudioAlbum(name: "Speak Now", studio: "Aimeeland Studio")

var allAlbumsss: [Album] = [taylorSwift, fearless]
